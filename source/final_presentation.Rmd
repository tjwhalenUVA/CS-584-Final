...
<ul>
  ...
  <li>auto: attempts to decide the most appropriate algorithm based on values </li>
...
<ul>
  ...
  <li>presort: presort the data to speed up the finding of best splits in fitting</li>
  <li>splitter: The strategy used to choose the split at each node</li>
...
<ul>
  ...
  <li>fit_intercept: Specifies if a constant (a.k.a. bias or intercept) should be added to the decision function</li>
  <li>penalty: Used to specify the norm used in the penalization</li>
</ul>
...
<ul>
  ...
  <li>Due to decrease in Male accuracy</li>
  <li>Slight improvement in Female accuracy</li>
</ul>
...
KNN: `r knn$auc$auc`<br>
Decision Tree: `r dt$auc$auc`<br>
SVM: `r svm$auc$auc`<br>
Log Reg: `r lr$auc$auc`<br>
KNN (PCA): `r knn.pca$auc$auc`<br>
<b>Random Forest</b>: `r rf$auc$auc`<br>
SVM (PCA): `r svm.pca$auc$auc`<br>
Log Reg (Normal): `r lr.norm$auc$auc`<br>
